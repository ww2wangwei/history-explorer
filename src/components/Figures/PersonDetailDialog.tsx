    ...
    <ModalShell isOpen onClose={onClose} innerClassName="border-vermilion-500/40">
      {/* 人物肖像图 */}
        ...
        <div className="p-6 space-y-4">
          ...
          {(person as any).facts && (person as any).facts.length > 0 && (
            <div>
          ...
          {(person as any).sections && (person as any).sections.length > 0 && (
            <div className="space-y-3">
              {(person as any).sections.map((s: any, i: number) => {
                if (s.type === 'paragraph') {
                  return (
                    <div key={i}>
          ...
          {(person as any).timeline && (person as any).timeline.length > 0 && (
            <div>
              <div className="text-xs text-ink-300 uppercase tracking-wider mb-2">⏳ 生平时间线</div>
          ...
          {(person as any).related && (person as any).related.length > 0 && (
            <div>
