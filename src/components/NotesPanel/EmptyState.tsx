...
export default function EmptyState({ kind, onCreate }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 py-10">
      ...
      <button
        onClick={onCreate}
        className="px-4 py-1.5 text-xs rounded-lg bg-vermilion-500/30 hover:bg-vermilion-500/50 border border-vermilion-500/40 text-vermilion-300 transition-colors"
      >
        ＋ 新建笔记
      </button>
    </div>
