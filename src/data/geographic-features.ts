...
export const LAKES: GeoFeature[] = [
  ...
  // —— 中国五大淡水湖 + 青海湖 ——
  {
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [116, 28.5], [116.5, 29], [116.5, 29.5], [116, 29.5], [115.5, 29], [116, 28.5],
    ],
  },
  {
    id: 'dongting',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [112.5, 29], [113, 29.5], [113.5, 29.5], [113.5, 29], [113, 28.5], [112.5, 29],
    ],
  },
  {
    id: 'taihu',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [119.8, 31.2], [120.5, 31.5], [120.5, 31], [120, 30.8], [119.8, 31.2],
    ],
  },
  {
    id: 'hongze',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [118.2, 33.2], [118.7, 33.3], [118.7, 33], [118.2, 33], [118.2, 33.2],
    ],
  },
  {
    id: 'chaohu',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [117.3, 31.5], [117.7, 31.6], [117.7, 31.4], [117.3, 31.4], [117.3, 31.5],
    ],
  },
  {
    id: 'qinghai-lake',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [99.7, 36.8], [100.5, 37], [100.5, 37.3], [100, 37.3], [99.5, 37.2], [99.5, 36.9], [99.7, 36.8],
    ],
  },
  // —— 世界其他重要湖泊 ——
  {
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [48, 41], [50, 44], [52, 45.5], [54, 45], [54, 41.5], [52, 38], [49, 38], [48, 41],
    ],
  },
  {
    id: 'dead-sea',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [35.4, 31.7], [35.6, 31.8], [35.6, 31.4], [35.4, 31.4], [35.4, 31.7],
    ],
  },
  {
    id: 'balkhash',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [73, 46.5], [76, 46.5], [76, 45.5], [73, 45.5], [73, 46.5],
    ],
  },
  {
    id: 'tanganyika',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [29, -7], [30, -6], [30, -4.5], [29, -3], [28.5, -4.5], [29, -7],
    ],
  },
  {
    id: 'malawi',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [34, -14], [35, -12.5], [35, -10], [34, -9.5], [33.5, -11], [34, -14],
    ],
  },
  {
    id: 'ladoga',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [30, 60.5], [31, 61.5], [32, 61.5], [32, 60.5], [30, 60.5],
    ],
  },
  {
    id: 'onega',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [35, 61.5], [36, 62], [36, 61.5], [35, 61], [35, 61.5],
    ],
  },
  {
    id: 'geneva',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [6.2, 46.4], [7, 46.5], [7, 46.4], [6.2, 46.3], [6.2, 46.4],
    ],
  },
  {
    id: 'balaton',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [17.4, 46.7], [18, 46.8], [18, 46.9], [17.4, 46.9], [17.4, 46.7],
    ],
  },
  {
    id: 'chad',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [13.5, 13], [14.5, 13.5], [14.5, 14], [13.5, 14], [13.5, 13],
    ],
  },
  {
    id: 'issykkul',
    ...
    imageCredit: 'Bing 图片搜索',
    geometry: [
      [77.5, 42.5], [78, 42.8], [78, 42.7], [77.5, 42.3], [77.5, 42.5],
    ],
  },
]
